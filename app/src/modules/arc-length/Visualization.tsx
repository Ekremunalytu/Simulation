      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex gap-6">
          <div className="text-right">
            <p className="text-[10px] font-mono text-outline uppercase">Parça</p>
            <p className="font-mono text-sm text-primary">{activeFrame.segmentCount}</p>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-mono text-outline uppercase">Uzunluk</p>
          ...
          <div className="flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={convergenceData}>
                <CartesianGrid stroke="#333" strokeDasharray="3 3" />
                <XAxis dataKey="segmentCount" stroke="#555" tick={{ fontSize: 10, fill: '#b0a8bc' }} tickLine={false} />
