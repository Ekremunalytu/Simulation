...
const parametricCurvesDefinition = {
  ...
  category: 'math',
  description:
    'x(t) ve y(t) ile tanımlanan eğrilerde noktanın hareketini, tangent doğrultusunu, hız ve ivme büyüklüklerini aynı anda incele.',
  icon: 'γ',
  ...
  theory: {
    primaryFormula: 'r(t) = <x(t), y(t)>,   r\'(t) = <x\'(t), y\'(t)>,   r\'\'(t)',
    formulaLabel: 'Parametrik konum, hız ve ivme',
    symbols: [
      { symbol: 'r(t)', meaning: 'Düzlemdeki konum vektörü' },
      { symbol: 'r\'(t)', meaning: 'Hız / tangent vektörü' },
      { symbol: '|r\'(t)|', meaning: 'Skaler hız büyüklüğü' },
      { symbol: '|r\'\'(t)|', meaning: 'İvme büyüklüğü' },
    ],
    derivationSteps: [
      't parametresi ilerledikçe düzlemdeki konumu hesapla.',
      'Konumun türevi tangent yönünü verir.',
      'Birinci türevin normu hızı, ikinci türev ise ivme bilgisini üretir.',
      'Böylece şekil, yön, hız ve ivme tek bir parametrik akışta birleşir.',
    ],
    ...
    pitfalls: [
      'Tangent yönü, hız büyüklüğü ve ivmeyi aynı şey sanmak.',
      'Aynı geometrik yolun her noktada aynı hız veya ivme ile geçildiğini varsaymak.',
    ],
  },
